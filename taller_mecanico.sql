...
CREATE TABLE `presupuesto` (
  `nro_presupuesto` INT NOT NULL AUTO_INCREMENT,
  `cod_cliente` VARCHAR(20) DEFAULT NULL,
...
CREATE TABLE `proveedor` (
  ...
  KEY `FK_dni_proveedor` (`dni`),
  CONSTRAINT `FK_dni_proveedor` FOREIGN KEY (`dni`) REFERENCES `persona` (`dni`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `proveedor` (`cod_proveedor`, `dni`, `nombre_empresa`, `direccion`, `telefono`, `email`)
VALUES 
('P001','17890452','Proveedor Uno','Calle Falsa 123','3511234567','contacto@proveedor1.com'),
('P002','17896456','Proveedor Dos','Av. Siempre Viva 456','3517654321','ventas@proveedor2.com');
UNLOCK TABLES;
